...
//    Main main;
//
//    public TableView<Grupa> TableZestaw;
//    public TableView<Podejscie> TableStudent;
//    public ChoiceBox dateChoiceBox;
//    public TableColumn<Grupa, String> ColumnZestawNazwa;
//    public TableColumn<Grupa, String> ColumnZestawTermin;
...
//    public Grupa wybranyZestaw = null;
//
//    @FXML
...
//                    data = data.split(" ")[0];
//                    TableZestaw.setItems(main.getObserListGrupyEgzaminu(data));
