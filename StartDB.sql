DROP TABLE EGZAMINY cascade constraints;
...
DROP SEQUENCE grupy_sequence;
DROP SEQUENCE zadania_sequence;

CREATE SEQUENCE grupy_sequence START WITH 1;
CREATE SEQUENCE zadania_sequence START WITH 1;

CREATE TABLE EGZAMINY
    (DATA_EGZ DATE DEFAULT CURRENT_DATE CONSTRAINT PK_EGZ PRIMARY KEY,
    TERMIN VARCHAR2(8) not null CHECK (TERMIN IN ('pierwszy', 'drugi', 'trzeci'))
    );

CREATE TABLE ZESTAWY
       (ZES_NAZWA VARCHAR2(15) CONSTRAINT PK_ZES PRIMARY KEY,
       DATA_UTW DATE DEFAULT CURRENT_DATE not null
    );

CREATE TABLE GRUPY
    (ID_GRUPY NUMBER(6) DEFAULT grupy_sequence.nextval CONSTRAINT PK_GRUPY PRIMARY KEY,
    DATA_EGZ DATE CONSTRAINT FK_EGZ REFERENCES EGZAMINY(DATA_EGZ) ON DELETE CASCADE,
    ZES_NAZWA VARCHAR(15) CONSTRAINT FK_GR_ZES REFERENCES ZESTAWY(ZES_NAZWA) ON DELETE CASCADE,
    CONSTRAINT UNIQUE_ZES_NA_EGZ UNIQUE (DATA_EGZ, ZES_NAZWA)
    );
...
CREATE TABLE PODEJSCIA
    ...
    ID_GRUPY NUMBER(6) CONSTRAINT FK_POD_GRUP REFERENCES GRUPY(ID_GRUPY) ON DELETE CASCADE,
    OCENA VARCHAR2(3) CHECK (OCENA IN ('2.0', '3.0', '3.5', '4.0', '4.5', '5.0')),
    CONSTRAINT PK_POD PRIMARY KEY (INDEKS, ID_GRUPY)
    );
...
CREATE TABLE ZADANIA
    ...
    CONSTRAINT UNIQUE_TRESC UNIQUE(TRESC)
    );

CREATE TABLE ZAWARTOSC
       (ZES_NAZWA VARCHAR2(15) CONSTRAINT FK_ZAW_ZES REFERENCES ZESTAWY(ZES_NAZWA) ON DELETE CASCADE,
    ID_ZAD NUMBER(6) CONSTRAINT FK_ZAD REFERENCES ZADANIA(ID_ZAD) ON DELETE CASCADE,
    CONSTRAINT PK_ZAW PRIMARY KEY (ZES_NAZWA, ID_ZAD)
    );

CREATE BITMAP INDEX oceny_indeks on STUDENCI(OCENA_1, OCENA_2);
CREATE INDEX podejscia_indeks on PODEJSCIA(ID_GRUPY, INDEKS);
CREATE INDEX zawartosc_indeks on ZAWARTOSC(ZES_NAZWA, ID_ZAD);
...
INSERT INTO EGZAMINY VALUES (to_date('05-12-2019','DD-MM-YYYY'), 'pierwszy');
INSERT INTO EGZAMINY VALUES (to_date('10-01-2020','DD-MM-YYYY'), 'drugi');

INSERT INTO ZESTAWY VALUES ('A', to_date('01-12-2019','DD-MM-YYYY'));
INSERT INTO ZESTAWY VALUES ('B', to_date('01-12-2019','DD-MM-YYYY'));
INSERT INTO ZESTAWY VALUES ('C', to_date('01-12-2019','DD-MM-YYYY'));
INSERT INTO ZESTAWY VALUES ('D', to_date('01-12-2019','DD-MM-YYYY'));
INSERT INTO ZESTAWY VALUES ('E', to_date('01-12-2019','DD-MM-YYYY'));

INSERT INTO GRUPY VALUES (grupy_sequence.nextval, to_date('05-12-2019','DD-MM-YYYY'), 'A');
INSERT INTO GRUPY VALUES (grupy_sequence.nextval, to_date('05-12-2019','DD-MM-YYYY'), 'B');
INSERT INTO GRUPY VALUES (grupy_sequence.nextval, to_date('05-12-2019','DD-MM-YYYY'), 'C');
INSERT INTO GRUPY VALUES (grupy_sequence.nextval, to_date('10-01-2020','DD-MM-YYYY'), 'D');
INSERT INTO GRUPY VALUES (grupy_sequence.nextval, to_date('10-01-2020','DD-MM-YYYY'), 'E');
...
INSERT INTO PODEJSCIA VALUES (135217,4,null);
INSERT INTO PODEJSCIA VALUES (135228,5,null);
INSERT INTO PODEJSCIA VALUES (135233,4,null);
INSERT INTO PODEJSCIA VALUES (135343,5,null);
...
INSERT INTO ZAWARTOSC VALUES ('A',13);
INSERT INTO ZAWARTOSC VALUES ('A',23);
INSERT INTO ZAWARTOSC VALUES ('A',18);
INSERT INTO ZAWARTOSC VALUES ('B',5);
INSERT INTO ZAWARTOSC VALUES ('B',15);
INSERT INTO ZAWARTOSC VALUES ('B',20);
INSERT INTO ZAWARTOSC VALUES ('C',8);
INSERT INTO ZAWARTOSC VALUES ('C',25);
INSERT INTO ZAWARTOSC VALUES ('D',28);
INSERT INTO ZAWARTOSC VALUES ('D',3);
INSERT INTO ZAWARTOSC VALUES ('D',8);
INSERT INTO ZAWARTOSC VALUES ('E',10);
INSERT INTO ZAWARTOSC VALUES ('E',19);
INSERT INTO ZAWARTOSC VALUES ('E',23);
